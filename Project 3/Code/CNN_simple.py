...
'''
A simple convolutional netwrok: one convolution,
one maxpool, one dropout and then a dense layer followed by
...
def cnn_model():
	# create model
	model = Sequential()
	model.add(Convolution2D(32, 5, 5, border_mode='valid', input_shape=(1, 60, 60), activation='relu'))
